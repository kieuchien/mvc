...
<body>
  <div id="wrap">
    <div id="regbar"> 
        <div id="navthing">
          <h2><a href="content.php" id="loginform">Dashboard</a> | <a href="admin.php">User</a> | <a href="../controller/logout.php">Logout</a></h2>    
        </div>        
    </div>
    <div>
          ...
          <table border="1" class="author" >
             <tr>
              ...
              <?php 
                  ...
                  while ($row = mysqli_fetch_array($ad,MYSQLI_NUM)) {                                 
              ?>
              <tr>  
                ...
                <td><a href="editadmin.php?id=<?php echo $row[0]; ?>">Edit</a></td>
                <td><a href="../controller/deleteAdmin.php?id=<?php echo $row[0]; ?>" onclick='return deleteAction();'>Delete</a></td>
